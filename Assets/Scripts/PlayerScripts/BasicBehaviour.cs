...
public class BasicBehaviour : MonoBehaviour
{
	...
	/// <summary>
	/// Текущее активное поведение персонажа
	/// </summary>
	...
	void FixedUpdate()
	{
		...
		// Запускаем действия из всех состояний поведения
		else
		{
		...
		// Персонаж должен спокойно стоять на земле, если нет влияющих на это активных поведений
...
/// <summary>
/// Базовый класс для всех возможных поведений
/// Каждое новое поведение должно наследовать этот класс
/// </summary>
